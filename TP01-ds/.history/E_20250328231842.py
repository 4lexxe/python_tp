...
if gasto_adulto<gasto_niño<gasto_senior:
    print(f"El grupo que mas gasto es el grupo Senior con un gasto de ${gasto_senior}. El grupo Adulto gasto ${gasto_adulto} y el Grupo niño gasto ${gasto_niño}.")
    
elif gasto_senior<gasto_niño<gasto_adulto:
    print(f"El grupo que mas gasto es el grupo Adulto con un gasto de ${gasto_adulto}. El grupo Niño gasto ${gasto_niño} mientras que el grupo Senior gasto ${gasto_senior}")

elif gasto_adulto<gasto_senior<gasto_niño:
    print(f"El grupo que mas gasto fue el grupo Niño con un gasto de ${gasto_niño}. Mientras que los Adultos gastaron ${gasto_adulto} y el Grupo Senior gasto {gasto_senior}")

else:
    print("Nadie compro o no se deseo empezar con la venta.")