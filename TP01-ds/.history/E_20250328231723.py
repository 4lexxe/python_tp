...
# Determine the group that spent the most using if statements
max_gasto = 0
if gasto_niño >= gasto_adulto and gasto_niño >= gasto_senior:
  max_gasto = gasto_niño
elif gasto_adulto >= gasto_niño and gasto_adulto >= gasto_senior:
