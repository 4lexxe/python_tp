...
print(f"la conversión de pesos a dolar es de {round(conversionPesosDolar,3)}")

conversionPesosEuro = pesos/euro
print(f"la conversión de pesos a euros es de {round(conversionPesosEuro, 3)}")