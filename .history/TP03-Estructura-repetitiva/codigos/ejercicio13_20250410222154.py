...
# Se utiliza como una técnica común para:
#Inicializar variables que luego se usarán para encontrar el valor máximo en un conjunto de números

#Garantizar que cualquier valor real que se compare con mayor será mayor que el valor inicial

#¿Cómo funciona?
#Cuando comparas cualquier número real con -inf, ese número siempre será mayor

#Esto permite que el primer número que se compare con mayor lo reemplace automáticamente

#Es más robusto que inicializar con 0 o cualquier otro valor arbitrario'''
